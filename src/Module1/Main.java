...
//         Vector <String> V1 = new Vector<>();
       ...
       st.push(10);
        ...
        st.pop(); // yeh LIFO principle pe kaam karta hai aur yeh POP karega 12 ko
        System.out.println(st);

        System.out.println(st.peek());
        System.out.println(st.search(12));  // jo element nahi found hoga uske lie searching mein alsways -1 show kar dega instead of TRUE or FALSE
